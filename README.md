...
> **New here?** Install the single `Carbon_0.1.3_x64-setup.exe` from [Releases](https://github.com/sanirudh17/Carbon/releases/latest) — no extra dependencies, Tesseract is already bundled.
...
| Installer | Notes |
|---|---|
| **`Carbon_0.1.3_x64-setup.exe`** | NSIS installer — single executable, bundles Tesseract OCR. Recommended. |
...
```bash
npm run tauri build
# → src-tauri/target/release/bundle/nsis/Carbon_0.1.3_x64-setup.exe
```
